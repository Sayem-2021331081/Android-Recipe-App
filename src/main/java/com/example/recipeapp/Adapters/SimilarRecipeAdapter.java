...
import com.example.recipeapp.RecipeDetailsActivity;
...
//    }
//
//    public SimilarRecipeAdapter(List<SimilarRecipeResponse> list) {
//        this.list = list;
//    }
//
//    public SimilarRecipeAdapter(RecipeDetailsActivity recipeDetailsActivity, List<SimilarRecipeResponse> response, RecipeClickListener listener) {
