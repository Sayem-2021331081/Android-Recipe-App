    ...
    private final SimilarRecipesListener similarRecipesListener=new SimilarRecipesListener() {
        ...
        public void didFetch(List<SimilarRecipeResponse> response, String message) {
            ...
            similarRecipeAdapter = new SimilarRecipeAdapter(
                    RecipeDetailsActivity.this, // Context, usually the Activity or Fragment
                    response,                   // Probably a list of recipe data (e.g., List<Recipe>)
                    recipeClickListener         // A listener for handling clicks on items
            );
